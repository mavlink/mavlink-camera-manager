//! TypeScript bindings generator for the MCM API.
//!
//! Generated files are written to `frontend/bindings/` and MUST be committed.
//! CI regenerates them and runs `git diff` to catch unintended API changes
//! (see `.githooks/pre-push`).
//!
//! Usage: `cargo run --package=bindings`
