...
//!
//! Standalone mirror of `src/lib/stream/webrtc/signalling_protocol.rs`,
//! without the `ts-rs` dependency so downstream consumers (examples, tests)
//! compile without pulling in the full library crate.
