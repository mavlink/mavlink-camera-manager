        ...
        let description = match &configuration.encode {
            VideoEncodeType::H264 => {
                format!(concat!(
                        ...
                        " ! h264parse",
                        " ! capsfilter name={filter_name} caps=video/x-h264,profile={profile},stream-format=byte-stream,alignment=nal,width={width},height={height},framerate={interval_denominator}/{interval_numerator}",
