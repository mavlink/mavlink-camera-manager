            ...
            VideoEncodeType::H264 => {
                format!(
                    concat!(
                        ...
                        " ! capsfilter name={filter_name} caps=video/x-h264,stream-format=byte-stream,alignment=nal,width={width},height={height},framerate={interval_denominator}/{interval_numerator}",
            ...
            VideoEncodeType::H265 => {
                format!(
                    concat!(
                        "v4l2src device={device} do-timestamp=true",
                        " ! h265parse",
                        " ! capsfilter name={filter_name} caps=video/x-h265,stream-format=byte-stream,alignment=nal,width={width},height={height},framerate={interval_denominator}/{interval_numerator}",
                        " ! tee name={video_tee_name} allow-not-linked=true",
